...
uint256 public totalNoOfStudents;
  ...
  modifier onlyAdmin(){
   require(msg.sender == universityAdmin,"Only University admin operate this functionality");
   _;
}
 ...
 mapping (string => Student) students; //  Mapping a student's name to student
    ...
    **/
    ...
    function areBothStringSame(string memory x, string memory y) private pure returns (bool) {
